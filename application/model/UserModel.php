...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT users.user_id, users.user_name, users.user_email, users.user_active, users.user_has_avatar,
                       users.user_deleted, users.user_account_type, user_roles.role_name
                  FROM users
             LEFT JOIN user_roles ON users.user_account_type = user_roles.role_id";
