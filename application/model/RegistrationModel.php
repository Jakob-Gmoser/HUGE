...
class RegistrationModel
{
    ...
    public static function registerNewUser()
    {
        ...
        // do not require email verification for admin-created accounts
        $user_activation_hash = null;

        // write user data to database and activate directly
    ...
    public static function writeNewUserToDatabase($user_name, $user_password_hash, $user_email, $user_creation_timestamp, $user_activation_hash)
    {
        ...
        $sql = "INSERT INTO users (user_name, user_password_hash, user_email, user_creation_timestamp, user_active, user_activation_hash, user_provider_type)
                    VALUES (:user_name, :user_password_hash, :user_email, :user_creation_timestamp, :user_active, :user_activation_hash, :user_provider_type)";
