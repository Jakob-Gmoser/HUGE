...
return array(
    ...
    "FEEDBACK_ACCOUNT_SUSPENSION_DELETION_STATUS" => "This user's suspension / deletion / role settings have been edited.",
    ...
    "FEEDBACK_RECAPTCHA_WRONG" => "Please confirm that you are not a robot.",
    ...
    "FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Account has been created successfully.",
